...
class Order(models.Model):
    ...
    full_name = models.CharField(max_length=255, null=True, blank=True)  # Add this field
    email = models.EmailField(null=True, blank=True)  # Optional email for guest users
